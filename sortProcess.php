                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch">
                                <input onchange="changeStatus(<?php echo $selected_data['id']; ?>);" class="form-check-input" type="checkbox" role="switch" id="toggle<?php echo $selected_data["id"]; ?>" <?php
        ...
        <ul class="pagination pagination-lg justify-content-center">
            ...
            ?>
                    <li class="page-item active">
                        <a class="page-link" onclick="sort1(<?php echo ($y); ?>);"><?php echo $y; ?></a>
                    </li>
                <?php
                } else {
                ?>
