                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-12 mt-3 mb-3">
                            ...
                            <a href="seeall.php?pid=<?php echo $category_data["cat_id"]; ?>" class="text-decoration-none text-dark fs-6">See All &nbsp;&rarr;</a>
                        </div>
                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        AND `status_status_id`='1' ORDER BY `datetime_added` DESC LIMIT 5 OFFSET 0");
