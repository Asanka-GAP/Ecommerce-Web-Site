    ...
    <div class="container-fluid">
        <div class="row gy-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mt-2 mb-2">
                                                        <input type="text" class="form-control" placeholder="Add new Colour" id="clr_input"/>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded" style="background-size: contain;">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6 d-grid mt-3">
                                            ...
                                            <label for="imageuploader" class="col-12 btn btn-primary" onclick="changeProductImg();">Upload Images</label>
                                        </div>
                                    </div>
                                </div>
            ...
            ?>
                ...
                <script>
                    alert("You have to Login first to add a new product.");
